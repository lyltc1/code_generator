...
class BopInstanceDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        if pbr:
            ...
            self.GT_folder = cfg.binary_code_folder / dataset_root.parts[-1] / 'train_pbr_GT'
            self.img_folder = 'rgb'
            ...
            self.GT_folder = cfg.binary_code_folder / dataset_root.parts[-1] / ((cfg.test_folder if test else cfg.train_folder) + '_GT')
